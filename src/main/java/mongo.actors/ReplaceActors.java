...
class ReplaceActors {
    ...
    public <O> Function<UpdateMessage, Future<O>> spawnUpdateOne(final ReplaceOptions options,
                                                                           final DeploymentOptions deploymentOptions,
                                                                           final Function<UpdateResult, O> resultConverter) {
        Objects.requireNonNull(options);
        Function<UpdateMessage, O> updateFn = message -> {
    ...
    public <O> Function<UpdateMessage, Future<O>> spawnReplaceOne(final Function<UpdateResult, O> resultConverter) {
